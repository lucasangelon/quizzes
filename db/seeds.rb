...
Quiz.create(title: 'Test Quiz 1', due_date: DateTime.parse('20150822235959'),user_id:2,unit_id:1,language_id:1,specific_id:1)
Quiz.create(title: 'Test Quiz 2', due_date: DateTime.parse('20150822235959'),user_id:2,unit_id:1,language_id:1,specific_id:1)
Quiz.create(title: 'Test Quiz 3', due_date: DateTime.parse('20150822235959'),user_id:2,unit_id:2,language_id:1,specific_id:1)
Quiz.create(title: 'Test Quiz 4', due_date: DateTime.parse('20150822235959'),user_id:2,unit_id:2,language_id:1,specific_id:1)
Quiz.create(title: 'Test Quiz 5', due_date: DateTime.parse('20150822235959'),user_id:2,unit_id:3,language_id:1,specific_id:1)
Question.create(content:'This is a test True or false question', quiz_id:1,user_id:1,type_id:3,language_id:1,specific_id:1,correct_answer:'true')
Question.create(content:'This question requires a text answer',quiz_id:1,user_id:1,type_id:2,language_id:1,specific_id:1,correct_answer:'true')
...
QuestionExtra.create(content: 'Test Answer Number 1', question_id:3)
QuestionExtra.create(content: 'Test Answer Number 2', question_id:3)
QuestionExtra.create(content: 'Test Answer Number 3', question_id:3)
QuestionExtra.create(content: 'Test Answer Number 4', question_id:3)